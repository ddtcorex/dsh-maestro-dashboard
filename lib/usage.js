        ...
        try {
            ...
            for (const session of list) {
                try {
                    ...
                    totalInput += effInput;
                    totalOutput += effOut;
                    totalCacheRead += effRead;
                    totalCacheWrite += effWrite;
                    ...
                    cur.inputTokens += effInput;
                    cur.outputTokens += effOut;
                    cur.cacheReadTokens += effRead;
                    cur.cacheWriteTokens += effWrite;
                    ...
                    for (const ent of entries) {
                        ...
                        try {
                            ...
                            if (cached && cached.mtime === mtime) {
                                ...
                                totalInput += cached.stats.inputTokens ?? 0;
                                totalOutput += cached.stats.outputTokens ?? 0;
                                totalCacheRead += cached.stats.cacheReadTokens ?? 0;
                                totalCacheWrite += cached.stats.cacheWriteTokens ?? 0;
