...
4. Open the project in your editor. Host logic lives in `src/host/`, client UI in `src/client/`, shared types in `src/host/shared/`, tests in `tests/`. `lib/` is committed build output — do not hand-edit.
